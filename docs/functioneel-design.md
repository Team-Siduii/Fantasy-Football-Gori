...
- Pitch in basiselftal gebruikt exact de aangeleverde referentie-afbeelding als achtergrondasset (`/public/images/pitch-reference.jpg`) met lichte zoom-in (`background-size: 122% auto`) zodat het veld visueel sterker in beeld staat
...
- 2026-05-04: Pitch-referentiebeeld licht ingezoomd (`background-size: 122% auto`) voor een strakkere, vollere veldweergave.
