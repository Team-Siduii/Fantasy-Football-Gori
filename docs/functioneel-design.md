...
- 2026-05-26: Herbruikbare `CollectiblePlayerCard` component toegevoegd met asset-driven lagen (vlag/shirt/schild via props) plus Frankrijk-voorbeeld op de design-lab pagina (`/manager/design-lab/player-cards`) voor 1-op-1 prompt-validatie.
- 2026-05-26: Frankrijk-basiskaart asset (`france-base-card.jpg`) gekoppeld aan `CollectiblePlayerCard` als preferred render-mode, zodat de component nu de aangeleverde referentiekaart exact gebruikt en alleen naam/waarde dynamisch overlayt.
