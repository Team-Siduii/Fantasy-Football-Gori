...
- 2026-07-18: WK prijsnormalisatie vastgezet op importwaarde min €3.0M over alle transfer-readpaden (`/api/players?mode=wk`, `/api/wk/players` en instellingen), en de Team-programmabox in ronde 8 gepolijst met compacte gecentreerde badges voor `Finale`/`Troostfinale` zonder extra wedstrijdtekst.
