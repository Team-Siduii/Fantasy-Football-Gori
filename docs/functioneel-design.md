...
- In `Mijn competitie` staat `Bekijk` als compacte aparte actieknop in een eigen kolom direct achter de teamnaam. De teamnaamcel zelf blijft daardoor smal/leesbaar en de rankingkolommen blijven op mobiel en desktop stabiel uitgelijnd.
...
- 2026-07-18: WK `Mijn team` houdt vóór de aftrap van de volgende ronde de punten van de laatst gespeelde ronde zichtbaar; als ronde 8 nog geen persistente score-snapshot heeft, blijft de kaart dus de ronde-7 score tonen in plaats van `0`.
